...
<table class="api">
	<tr>
		<h3> Add payment card - Web ReDirect</h3>
	</tr>
	...
	<tr>
		...
		<td><input type="text" size="30" maxlength="16" name="cardNumber" /></td>
	</tr>
	...
	<tr>
		<td class="thinfield"><br>
		<b>Billing Address:</b></td>
	</tr>
	<tr>

		<td class="thinfield">Address 1</td>
		<td align=left><input type=text size=25 maxlength=100
			name=address1 value="1 Main St"></td>
	</tr>
	<tr>
		<td class="thinfield">Address 2</td>
		<td align=left><input type=text size=25 maxlength=100
			name=address2 value="2nd cross"></td>
	</tr>
	...
	<tr>
		...
		<td class="thinfield3" align=left><input type=text size=10 maxlength=10 name=zip
